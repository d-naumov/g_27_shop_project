...
//    logger.info(
//        String.format("Метод %s класса %s вызван с аргументами: %s", methodName, className, args));
//  }
//
...
//    String className = joinPoint.getTarget().getClass().getSimpleName();
//    logger.info(
//        String.format("Метод %s класса %s успешно вернул результат: %s", methodName, className,
//            result));
//
//  }
//
...
//    String methodName = joinPoint.getSignature().getName();
//    String className = joinPoint.getTarget().getClass().getSimpleName();
//    logger.error(String.format("Метод %s класса %s выбросил исключение: %s", methodName, className,
//        e.getMessage()));
//
//  }
//}
